...
const Home = () => {
  return (
    <>
      {/* Bannet Section */}
      <section className="container-fluid mb-5 p-0 py-5 mt-3" id="home-header">
        <Banner />
      </section>
        ...
        <div className="row">
          <div className="col-md-7 order-md-1 order-2 second-section-text">
            <div>
              ...
              <p>
                Life changes the moment you take a new and commited decision.
              </p>
            </div>
            <div className="card">
              <div className="card-text">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Maiores dicta nostrum unde nulla. Earum fugit placeat atque
                aspernatur, enim natus incidunt.
              </div>
      ...
      {/* Product Section */}
      <section className="container-fluid py-5" id="product-section">
        {/* <div className="row">
